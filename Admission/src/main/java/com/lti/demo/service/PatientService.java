...
//create using PathVariable
	public Patient create1(String PId, String name, String nationality) {
		return patientRepository.save(new Patient(PId, name, nationality));
...
//update
	...
	public Patient update1(String PId, String name, String nationality) {
		Patient p = patientRepository.getByPId(PId);
		p.setname(name);
		p.setnationality(nationality);
		return patientRepository.save(p);
	...
	/*
	 * public Patient updateMul(String PId, String name, String nationality,String
	 * PId, String name, String nationality) { Patient p =
	 * patientRepository.getByPId(PId); p.setname(name);
	 * p.setnationality(nationality); return patientRepository.save(p); }
	 */
